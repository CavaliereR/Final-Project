        ...
        <div class="form-container">
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-plus-circle me-2"></i> Add Question to: <?php echo htmlspecialchars($quiz['quizTitle']); ?></h4>
                </div>
                <div class="card-body">
                    <?php if($message): ?>
                    ...
                    <form method="POST">
                        ...
                        <a href="ManageQuiz.php" class="btn btn-secondary">
                            <i class="fas fa-arrow-left"></i> Back to Manage Quiz
                        </a>
            ...
            <div class="card mt-4">
                <div class="card-header-info">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="fas fa-list me-2"></i> Existing Questions</h5>
                    ...
                    if (mysqli_num_rows($questions) > 0) {
                        ...
                        while ($q = mysqli_fetch_assoc($questions)) {
                            $type = ($q['question_type'] == 'file') ? 
                                    '<span class="badge bg-warning text-dark"><i class="fas fa-upload"></i> File Upload</span>' : 
